...
\let\OldTextcopyright\textcopyright
\renewcommand{\textcopyright}{\OldTextcopyright\xspace}%

% ---- Variables ----

\def \subject   {Trabajo fin de máster \\ Máster Universitario en Ingeniería Informática}
\def \title     {IndustryLP: Generador de polígonos industriales para el videojuego Cities: Skyline\textcopyright\xspace mediante Programación Lógica}
\def \authors   {Rafael Alcalde Azpiazu}
\def \directors {José Pedro Cabalar Fernández}
\def \keywords  {Answer Set Programming, Programación Lógica, Representación del Conocimiento, Resolución de problemas lógicos, Generación de polígonos industriales, Cities: Skylines\textcopyright, .NET Framework, Steam, Mod}
