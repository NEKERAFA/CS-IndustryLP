...
\newcommand{\clingo}{\texttt{clingo}\xspace}
...
\def \keywords  {\asp, Programación Lógica, Representación del Conocimiento, Resolución de problemas lógicos, Generación de polígonos industriales, \cities, .NET Framework, Steam, Mod de Videojuego}
...
\begin{document}
	...
	\hypertarget{asp}{\chapter{Programa lógico}}
	\label{asp}
	\input{tex/asp}
	\cleardoublepage
	...
	\addcontentsline{toc}{chapter}{C. Bibliografía}
	\label{bibliography}
\end{document}